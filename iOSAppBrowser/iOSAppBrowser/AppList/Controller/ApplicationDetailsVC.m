...
- (void)viewDidLoad {
    ...
    highlightedParameters = @[APP_BUNDLE_ID,APP_BUNDLE_SIGNER_IDENTITY,APP_BUNDLE_ENTITLEMENTS,APP_TEAM_ID,APP_SOURCE_IDENTIFIER,APP_STORE_NAME,APP_STORE_FRONT,APP_PURCHASER_DSID,APP_APPLICATION_DSID,APP_HASH,APP_PROFILE_VALIDATED,APP_STORE_COHORT_METADATA];
