...
- (void)viewDidLoad {
    ...
    applicationParameters = @[APP_BUNDLE_ID,APP_BUNDLE_SHORT_VERSION,APP_BUNDLE_VERSION,APP_NAME,APP_TEAM_ID,APP_VENDOR_NAME,APP_INSTALL_TYPE,APP_ORIGINAL_INSTALL_TYPE,APP_PROFILE_VALIDATED,APP_SOURCE_IDENTIFIER,APP_IS_INSTALLED,APP_IS_RESTRICTED,APP_STORE_COHORT_METADATA,APP_TAGS];
}
