...
- (void)viewDidLoad {
    ...
    applicationParameters = @[APP_BUNDLE_ID,APP_BUNDLE_SHORT_VERSION,APP_BUNDLE_VERSION,APP_BUNDLE_SIGNER_IDENTITY,APP_BUNDLE_EXECUTABLE,APP_BUNDLE_ENTITLEMENTS,APP_BUNDLE_ENVIRONMENT_VARIABLES,APP_BUNDLE_URL,APP_BUNDLE_CONTAINER_URL,APP_NAME,APP_SHORT_NAME,APP_TYPE,APP_TEAM_ID,APP_VENDOR_NAME,APP_SOURCE_IDENTIFIER,APP_REGISTERED_DATE,APP_CONTAINER_URL,APP_DATA_CONTAINER_URL,APP_STORE_RECEIPT_URL,APP_STORE_FRONT,APP_CACHE_GUID,APP_UNIQUE_IDENTIFIER,APP_MACH_O_UUIDS,APP_INSTALL_TYPE,APP_ORIGINAL_INSTALL_TYPE,APP_SEQUENCE_NUMBER,APP_HASH,APP_FOUND_BACKING_BUNDLE,APP_IS_ADHOC_CODE_SIGNED,APP_PROFILE_VALIDATED,APP_IS_INSTALLED,APP_IS_RESTRICTED,APP_STORE_COHORT_METADATA,APP_TAGS,APP_COMPANION_APP_IDENTIFIER];
}
...
- (NSString *)getStringRepresentationForParameterAtIndex:(NSInteger)index
{
    ...
    {
        NSMutableString *mutableValue = [[NSMutableString alloc] initWithString:@""];
